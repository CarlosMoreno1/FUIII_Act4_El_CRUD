                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="numero_seguro_social" placeholder="Numero de seguro social">
                                    <input type="text" class="form-control mb-3" name="tipo_de_cita" placeholder="Tipo de cita">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php  echo $row['tipo_de_cita']?></th>       
